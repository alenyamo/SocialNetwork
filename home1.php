                                ...
                                <div class="user-profile text-center">
                                    <div class="user-logo text-center">
                                        <div class="image-cropper mx-auto">
                                            <img class="img-fluid profile-image" alt="Responsive image" src="<?php if(isset($userImage)) {echo $userImage; } ?>">
                                        </div>
                                        <h3>
                                    ...
                                    <hr>
                                    <a class="colorOrange" href="profile.php?userID=<?php echo $encoded; ?>">View Full Profile</a>
                                </div>
                            </div>
